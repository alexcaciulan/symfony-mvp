...
> **Direcție post-MVP (vezi §11).** În practică ordonanța de plată nu se depune în monedă străină: moneda națională fiind RON, creanța în valută se **convertește în RON** și se cere în lei la instanță (astfel se face legătura între factura în valută și suma cerută). Fluxul: avocatul indică moneda din factură, iar platforma convertește automat în RON pe baza **cursului valutar BNR indexat** (BNR publică aceste cursuri tot ca serii de date, la fel ca rata de referință). **Cursul nu se introduce manual de avocat** (alegerea manuală riscă erori de calcul, atacabile de pârât pe fondul cauzei). **Data de conversie: cursul BNR din ziua emiterii facturii** (confirmat de avocat 2026-07-09). În document apar transparent: suma originală în valută, cursul BNR aplicat și data, plus echivalentul în RON.
...
- **Creanțe în valută** *(nice-to-have, prioritate medie: „doar dacă nu e efort mare" per avocat)* — avocatul indică moneda din factură, iar platforma convertește automat în RON pe baza **cursului valutar BNR indexat ca serie de date** (analog cu `InterestRateConfig`), la **cursul din ziua emiterii facturii** (confirmat avocat 2026-07-09), cu mențiune transparentă în document (suma în valută + curs + dată + echivalent RON). Cursul NU se introduce manual de avocat (alegerea manuală riscă calcule greșite și contestare pe fond de către pârât). Necesită o entitate/serie `BnrExchangeRate` alimentată din seriile de curs BNR. Restul calculului (dobândă etc.) rulează pe suma deja convertită în RON.
